...
- [Node.js](https://nodejs.org) v16.13.1 (LTS) or greater (The command `npm ci` will warn if v >= 17)
- NPM v8
- If not already installed, the Node package _node-gyp_ must be installed globally
    ```bash
