...
import { AnonLayoutWrapperComponent, AnonLayoutWrapperData, LockIconPrimary, LockIconWhite } from "@bitwarden/auth/angular";
  ...
  children: [
    {
      ...
      data: {
        ...
        pageIcon: {
          default: LockIconPrimary, // default icon to show (required if you are adding a pageIcon)
          darkTheme: LockIconWhite // icon to show on dark theme (optional)
        },
