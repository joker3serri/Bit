 ...
 */
export function flagEnabled<Flags extends Record<string, boolean>>(flag: keyof Flags): boolean {
 ...
 * @returns The value of the flag
 */
export function devFlagEnabled<DevFlags extends Record<string, boolean>>(
  flag: keyof DevFlags
): boolean {
