...
export class EnvironmentService implements EnvironmentServiceAbstraction {
  ...
  async setUrlsFromStorage(): Promise<void> {
    ...
    // In release `2023.5.0`, we set the `base` property of the environment URLs to the web vault URL.
    // This method will detect these cases and convert them to the proper region instead.
    ...
    if (savedUrls.base === "https://vault.bitwarden.eu" && savedUrls.notifications == null) {
