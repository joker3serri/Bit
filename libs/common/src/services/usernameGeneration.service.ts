...
export class UsernameGenerationService implements BaseUsernameGenerationService {
  ...
  async generateForwarded(options: any): Promise<string> {
    ...
    if (o.forwardedService === "simplelogin") {
      ...
      if (
        o.forwardedFastmailApiToken == null ||
        o.forwardedFastmailApiToken === "" ||
        o.forwardedFastmailAccountId == null ||
        o.forwardedFastmailAccountId == ""
      ) {
        return null;
      }
      return this.generateFastmailAlias(
        o.forwardedFastmailApiToken,
        o.forwardedFastmailAccountId,
        o.website,
        null
