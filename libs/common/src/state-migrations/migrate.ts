...
import { UserDecryptionOptionsMigrator } from "./migrations/33-move-user-decryption-options-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(UserDecryptionOptionsMigrator, 32, CURRENT_VERSION);
}
