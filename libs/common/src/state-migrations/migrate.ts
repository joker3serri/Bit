...
import { AutoConfirmFingerPrintsMigrator } from "./migrations/40-move-auto-confirm-finger-prints-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(AutoConfirmFingerPrintsMigrator, 39, CURRENT_VERSION);
}
