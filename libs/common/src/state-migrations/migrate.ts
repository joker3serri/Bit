...
import { UserDecryptionOptionsMigrator } from "./migrations/34-move-user-decryption-options-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(UserDecryptionOptionsMigrator, 33, CURRENT_VERSION);
}
