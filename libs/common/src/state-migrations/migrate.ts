...
import { SecurityStampTokenServiceStateProviderMigrator } from "./migrations/59-migrate-security-stamp-to-token-svc-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(SecurityStampTokenServiceStateProviderMigrator, 58, CURRENT_VERSION);
}
