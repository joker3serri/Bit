...
import { DeleteBiometricPromptCancelledData } from "./migrations/40-delete-orphaned-biometric-prompt-data";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(DeleteBiometricPromptCancelledData, 39, CURRENT_VERSION);
}
