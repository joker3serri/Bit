...
import { DeleteBiometricPromptCancelledData } from "./migrations/39-delete-orphaned-biometric-prompt-data";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(DeleteBiometricPromptCancelledData, 38, CURRENT_VERSION);
}
