...
import { DeviceTrustCryptoServiceStateProviderMigrator } from "./migrations/36-migrate-device-trust-crypto-svc-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(DeviceTrustCryptoServiceStateProviderMigrator, 35, CURRENT_VERSION);
}
