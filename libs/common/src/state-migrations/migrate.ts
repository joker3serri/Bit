...
import { MoveBillingAccountProfileMigrator } from "./migrations/35-move-billing-account-profile-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveBillingAccountProfileMigrator, 34, CURRENT_VERSION);
}
