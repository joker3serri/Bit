...
import { EnableContextMenuMigrator } from "./migrations/30-move-enable-context-menu-to-autofill-settings-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(EnableContextMenuMigrator, 29, CURRENT_VERSION);
}
