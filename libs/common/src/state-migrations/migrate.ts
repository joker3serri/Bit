...
import { ClearClipboardDelayMigrator } from "./migrations/24-move-clear-clipboard-to-autofill-settings-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(ClearClipboardDelayMigrator, 23, CURRENT_VERSION);
}
