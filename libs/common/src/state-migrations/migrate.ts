...
import { MoveForceSetPasswordReasonToStateProviderMigrator } from "./migrations/26-move-force-set-password-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveForceSetPasswordReasonToStateProviderMigrator, 25, CURRENT_VERSION);
}
