...
import { DeleteBiometricPromptCancelledData } from "./migrations/42-delete-orphaned-biometric-prompt-data";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(DeleteBiometricPromptCancelledData, 41, CURRENT_VERSION);
}
