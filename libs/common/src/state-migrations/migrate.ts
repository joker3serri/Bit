...
import { AutoConfirmFingerPrintsMigrator } from "./migrations/41-move-auto-confirm-finger-prints-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(AutoConfirmFingerPrintsMigrator, 40, CURRENT_VERSION);
}
