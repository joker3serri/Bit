...
import { AutoConfirmFingerPrintsMigrator } from "./migrations/39-move-auto-confirm-finger-prints-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(AutoConfirmFingerPrintsMigrator, 38, CURRENT_VERSION);
}
