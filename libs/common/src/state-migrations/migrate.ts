...
import { DeleteBiometricPromptCancelledData } from "./migrations/44-delete-orphaned-biometric-prompt-data";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(DeleteBiometricPromptCancelledData, 43, CURRENT_VERSION);
}
