...
import { MoveBillingAccountProfileMigrator } from "./migrations/32-move-billing-account-profile-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveBillingAccountProfileMigrator, 31, CURRENT_VERSION);
}
