...
import { MoveBiometricPromptsToStateProviders } from "./migrations/22-move-biometric-prompts-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveBiometricPromptsToStateProviders, 21, CURRENT_VERSION);
}
