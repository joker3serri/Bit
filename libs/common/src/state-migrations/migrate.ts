...
import { DeleteBiometricPromptCancelledData } from "./migrations/36-delete-orphaned-biometric-prompt-data";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(DeleteBiometricPromptCancelledData, 35, CURRENT_VERSION);
}
