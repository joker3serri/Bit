...
import { MoveBillingAccountProfileMigrator } from "./migrations/28-move-billing-account-profile-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveBillingAccountProfileMigrator, 27, CURRENT_VERSION);
}
