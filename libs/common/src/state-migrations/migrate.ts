...
import { MoveBillingAccountProfileMigrator } from "./migrations/36-move-billing-account-profile-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveBillingAccountProfileMigrator, 35, CURRENT_VERSION);
}
