...
import { MoveMasterKeyStateToProviderMigrator } from "./migrations/49-move-master-key-state-to-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveMasterKeyStateToProviderMigrator, 48, CURRENT_VERSION);
}
