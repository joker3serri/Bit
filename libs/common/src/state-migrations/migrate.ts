...
import { VaultSettingsKeyMigrator } from "./migrations/30-move-show-card-and-identity-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(PreferredLanguageMigrator, 31, 29)
    .with(VaultSettingsKeyMigrator, 29, CURRENT_VERSION);
}
