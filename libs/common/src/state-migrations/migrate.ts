...
import { MoveBiometricUnlockToStateProviders } from "./migrations/26-move-biometric-unlock-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveBiometricUnlockToStateProviders, 25, CURRENT_VERSION);
}
