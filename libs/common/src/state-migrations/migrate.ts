...
import { MoveForceSetPasswordReasonToStateProviderMigrator } from "./migrations/18-move-force-set-password-to-state-providers";
...
export async function migrate(
  ...
  await MigrationBuilder.create()
    ...
    .with(MoveForceSetPasswordReasonToStateProviderMigrator, 17, CURRENT_VERSION)
