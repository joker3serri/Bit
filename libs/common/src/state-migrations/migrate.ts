...
import { TokenServiceStateProviderMigrator } from "./migrations/32-migrate-token-svc-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(TokenServiceStateProviderMigrator, 31, CURRENT_VERSION);
}
