...
import { MoveForceSetPasswordReasonToStateProviderMigrator } from "./migrations/30-move-force-set-password-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveForceSetPasswordReasonToStateProviderMigrator, 29, CURRENT_VERSION);
}
