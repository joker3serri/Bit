...
import { MoveForceSetPasswordReasonToStateProviderMigrator } from "./migrations/32-move-force-set-password-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveForceSetPasswordReasonToStateProviderMigrator, 31, CURRENT_VERSION);
}
