...
import { UserNotificationSettingsKeyMigrator } from "./migrations/28-move-user-notification-settings-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(UserNotificationSettingsKeyMigrator, 27, CURRENT_VERSION);
}
