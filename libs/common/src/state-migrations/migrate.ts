...
import { DeviceTrustCryptoServiceStateProviderMigrator } from "./migrations/52-migrate-device-trust-crypto-svc-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(DeviceTrustCryptoServiceStateProviderMigrator, 51, CURRENT_VERSION);
}
