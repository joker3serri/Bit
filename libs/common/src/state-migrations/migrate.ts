...
import { UserNotificationSettingsKeyMigrator } from "./migrations/27-move-user-notification-settings-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(UserNotificationSettingsKeyMigrator, 26, CURRENT_VERSION);
}
