...
import { DeviceTrustCryptoServiceStateProviderMigrator } from "./migrations/40-migrate-device-trust-crypto-svc-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(DeviceTrustCryptoServiceStateProviderMigrator, 39, CURRENT_VERSION);
}
