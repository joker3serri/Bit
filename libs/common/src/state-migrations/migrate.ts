...
import { UserDecryptionOptionsMigrator } from "./migrations/32-move-user-decryption-options-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(UserDecryptionOptionsMigrator, 31, CURRENT_VERSION);
}
