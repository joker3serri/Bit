...
import { UserDecryptionOptionsMigrator } from "./migrations/40-move-user-decryption-options-to-state-provider";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(UserDecryptionOptionsMigrator, 42, CURRENT_VERSION);
}
