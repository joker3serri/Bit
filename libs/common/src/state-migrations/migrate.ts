...
import { MoveBillingAccountProfileMigrator } from "./migrations/33-move-billing-account-profile-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveBillingAccountProfileMigrator, 32, CURRENT_VERSION);
}
