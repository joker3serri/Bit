...
// TODO: migrate token service to state provider
...
// TODO: Everything below copied from device trust crypto service PR migration as example
...
export class DeviceTrustCryptoServiceStateProviderMigrator extends Migrator<22, 23> {
