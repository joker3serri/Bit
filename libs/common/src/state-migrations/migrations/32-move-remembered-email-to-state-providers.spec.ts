...
import { RememberedEmailMigrator } from "./32-move-remembered-email-to-state-providers";
...
describe("RememberedEmailMigrator", () => {
  const migrator = new RememberedEmailMigrator(31, 32);
  ...
  describe("rollback", () => {
    ...
    beforeEach(() => {
      ...
      sut = new RememberedEmailMigrator(31, 32);
    });
