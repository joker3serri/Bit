...
import { RememberedEmailMigrator } from "./41-move-remembered-email-to-state-providers";
...
describe("RememberedEmailMigrator", () => {
  const migrator = new RememberedEmailMigrator(40, 41);
  ...
  describe("rollback", () => {
    ...
    beforeEach(() => {
      ...
      sut = new RememberedEmailMigrator(40, 41);
    });
