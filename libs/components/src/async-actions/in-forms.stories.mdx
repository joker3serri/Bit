...
users attempting to trigger new actions before the previous ones has finished.
...
<details>
  <summary>What do these directives do?</summary>
  <p>A summary of what each directive does can be found inside the source code.</p>
</details>
