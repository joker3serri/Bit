...
<i class="bwi bwi-angle-right" title="bwi-angle-right" aria-label="bwi-angle-right"></i> icon, and
the following pages.
...
<i class="bwi bwi-ellipsis-h" title="bwi-ellipsis-h" aria-label="bwi-ellipsis-h"></i> icon button, a
menu opens displaying the pages between the top level and the previous page.
...
previous page and an

<i class="bwi bwi-angle-right" title="bwi-angle-right" aria-label="bwi-angle-right"></i> icon to take
