  ...
  get inputBorderClasses(): string {
    ...
    const groupClasses = [
      this.input.hasError
        ...
        : "group-hover/bit-form-field:tw-border-primary-700",
      ...
      shouldFocusBorderAppear ? "group-focus-within/bit-form-field:tw-border-primary-700" : "",
      shouldFocusBorderAppear
        ? "group-focus-within/bit-form-field:group-hover/bit-form-field:tw-border-primary-700"
        : "",
    ];
