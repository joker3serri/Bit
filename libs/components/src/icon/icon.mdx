...
5. **Replace any hardcoded strokes or fills** with the appropriate Tailwind class.
   ...
   - A non-comprehensive list of common colors and their associated classes is below:
     ...
     | --------------- | ------------------------- | ----------------------- | ----------------------- |
     | `#020F66`       | `tw-stroke-art-primary`   | `tw-fill-art-primary`   | `--color-art-primary`   |
     | `#10949D`       | `tw-stroke-art-accent`    | `tw-fill-art-accent`    | `--color-art-accent`    |
     | `#2CDDE9`       | `tw-stroke-art-accent`    | `tw-fill-art-accent`    | `--color-art-accent`    |
     | `#89929F`       | `tw-stroke-secondary-600` | `tw-fill-secondary-600` | `--color-secondary-600` |
