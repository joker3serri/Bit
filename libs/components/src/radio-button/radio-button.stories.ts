...
const template = `
  <form [formGroup]="formObj">
    <bit-radio-group formControlName="radio" aria-label="Example radio group">
      ...
      <bit-radio-button [value]="TestValue.First" id="radio-first"><bit-label>First</bit-label></bit-radio-button>
      <bit-radio-button [value]="TestValue.Second" id="radio-second"><bit-label>Second</bit-label></bit-radio-button>
      <bit-radio-button [value]="TestValue.Third" [disabled]="optionDisabled" id="radio-third"><bit-label>Third</bit-label></bit-radio-button>
    </bit-radio-group>
  </form>`;
