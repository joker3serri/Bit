...
module.exports = {
  ...
  theme: {
    colors: {
      ...
      black: colors.black,
      neutral: {
        50: rgba("--color-neutral-50"),
        100: rgba("--color-neutral-100"),
        200: rgba("--color-neutral-200"),
        300: rgba("--color-neutral-300"),
        400: rgba("--color-neutral-400"),
        500: rgba("--color-neutral-500"),
        600: rgba("--color-neutral-600"),
        700: rgba("--color-neutral-700"),
        800: rgba("--color-neutral-800"),
        900: rgba("--color-neutral-900"),
      },
      primary: {
