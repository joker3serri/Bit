...
const IdentityAttributes: string[] = [
    "autoCompleteType",
    "data-stripe",
    "htmlName",
    "htmlID",
...
const OperationDelays = new Map<string, number>([["buzzsprout.com", 100]]);
    ...
    private generateCardFillScript(
            ...
            for (let i = 0; i < CardAttributes.length; i++) {
                ...
                if (
                    ...
                    this.isFieldMatch(
                        ...
                        ["mm-yy", "mm-yyyy", "yy-mm", "yyyy-mm", "expiration-date", "payment-card-expiration"]
                    )
                ) {
                    fillFields.exp = f;
                    break;
                    ...
                    !fillFields.brand &&
                    this.isFieldMatch(f[attr], ["cc-type", "card-type", "card-brand", "cc-brand", "cb-type"])
                ) {
                    fillFields.brand = f;
                    break;
                }
        ...
        if (fillFields.expMonth && this.hasValue(card.expMonth)) {
            ...
            if (fillFields.expMonth.selectInfo && fillFields.expMonth.selectInfo.options) {
                ...
                (this.fieldAttrsContain(fillFields.expMonth, "mm") || fillFields.expMonth.maxLength === 2) &&
                expMonth.length === 1
            ) {
                expMonth = "0" + expMonth;
            }
        ...
        if (fillFields.exp && this.hasValue(card.expMonth) && this.hasValue(card.expYear)) {
            ...
            for (let i = 0; i < MonthAbbr.length; i++) {
                if (this.fieldAttrsContain(fillFields.exp, MonthAbbr[i] + "/" + YearAbbrShort[i]) && partYear != null) {
                    exp = fullMonth + "/" + partYear;
                } else if (this.fieldAttrsContain(fillFields.exp, MonthAbbr[i] + "/" + YearAbbrLong[i])) {
                    exp = fullMonth + "/" + fullYear;
                } else if (
                    this.fieldAttrsContain(fillFields.exp, YearAbbrShort[i] + "/" + MonthAbbr[i]) &&
                    partYear != null
                ) {
                    ...
                    this.fieldAttrsContain(fillFields.exp, MonthAbbr[i] + "-" + YearAbbrShort[i]) &&
                    partYear != null
                ) {
                    exp = fullMonth + "-" + partYear;
                } else if (this.fieldAttrsContain(fillFields.exp, MonthAbbr[i] + "-" + YearAbbrLong[i])) {
    ...
    private generateIdentityFillScript(
        ...
        pageDetails.fields.forEach((f: any) => {
            ...
            for (let i = 0; i < IdentityAttributes.length; i++) {
                ...
                if (
                    !fillFields.name &&
                    this.isFieldMatch(f[attr], ["name", "full-name", "your-name"], ["full-name", "your-name"])
                ) {
                    fillFields.name = f;
                    break;
                    ...
                    this.isFieldMatch(
                        ...
                        ["mailing-addr", "billing-addr", "mail-addr", "bill-addr"]
                    )
                ) {
                    ...
                    !fillFields.address1 &&
                    this.isFieldMatch(f[attr], ["address-1", "address-line-1", "addr-1", "street-1"])
                ) {
                    fillFields.address1 = f;
                    break;
                } else if (
                    !fillFields.address2 &&
                    this.isFieldMatch(f[attr], ["address-2", "address-line-2", "addr-2", "street-2"])
                ) {
                    fillFields.address2 = f;
                    break;
                } else if (
                    !fillFields.address3 &&
                    this.isFieldMatch(f[attr], ["address-3", "address-line-3", "addr-3", "street-3"])
                ) {
                    ...
                    !fillFields.city &&
                    this.isFieldMatch(f[attr], ["city", "town", "address-level-2", "address-city", "address-town"])
                ) {
                    fillFields.city = f;
                    break;
                } else if (
                    ...
                    !fillFields.phone &&
                    this.isFieldMatch(f[attr], ["phone", "mobile", "mobile-phone", "tel", "telephone", "phone-number"])
                ) {
                    fillFields.phone = f;
                    break;
                } else if (
                    !fillFields.username &&
                    this.isFieldMatch(f[attr], ["user-name", "user-id", "screen-name"])
                ) {
                    fillFields.username = f;
                    break;
                } else if (
                    !fillFields.company &&
                    this.isFieldMatch(f[attr], ["company", "company-name", "organization", "organization-name"])
                ) {
